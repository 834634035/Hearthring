...
export const HEARTH_VILLAGE_NPCS: VillageNpcDefinition[] = [
  {
    ...
    placements: {
      "gray-sprout-hearth": { position: [-2.35, 0, 1.45], rotationY: Math.PI * 0.38 },
      "sprout-seeking-ravine": { position: [2.15, 0, -1.7], rotationY: Math.PI * 1.08 }
    },
    targetHeight: 1.62,
    interactRadius: 2.35,
    animationPacks: ["animations.kaykit.rigMedium.general"],
    persona:
      "你是灰芽部落的支火巫，知道青岚入火异常，但不会直接揭露他的身世。你说话慢，常把火、祖名和路放在一起讲。",
  ...
  },
  {
    ...
    placements: {
      "gray-sprout-hearth": { position: [-1.4, 0, 3.8], rotationY: Math.PI * 0.82 },
      "gray-sprout-herb-field": { position: [-2.2, 0, 1.8], rotationY: Math.PI * 0.64 }
    },
    targetHeight: 1.58,
    interactRadius: 2.15,
    animationPacks: ["animations.kaykit.rigMedium.general"],
    persona: "你是青岚的灰芽养母，照料药草地。你温柔但务实，知道青岚不是本族血脉，却真心把他当孩子。",
    sceneContext: "灰芽药草地是部落生计来源，主部落正要求更多贡草，异常兽蹄正在破坏药草边缘。",
    dialogue: {
      lines: [
        "青息花摘靠近叶根的那一束，别把新芽连根拔掉。",
  ...
  },
  {
    ...
    position: [2.35, 0, 3.65],
    rotationY: Math.PI * 1.2,
    placements: {
      "gray-sprout-hearth": { position: [2.35, 0, 3.65], rotationY: Math.PI * 1.2 },
      "branch-hunting-ground": { position: [-1.4, 0, 2.0], rotationY: Math.PI * 0.95 },
      "joint-hunt-grassland": { position: [-2.4, 0, 1.6], rotationY: Math.PI * 0.72 }
    },
    targetHeight: 1.72,
    interactRadius: 2.45,
  ...
  },
  {
    ...
    placements: {
      "gray-sprout-hearth": { position: [3.7, 0, 0.6], rotationY: Math.PI * 1.45 },
      "joint-hunt-grassland": { position: [2.25, 0, 1.85], rotationY: Math.PI * 1.1 }
    },
    targetHeight: 1.68,
    interactRadius: 2.3,
    animationPacks: ["animations.kaykit.rigMedium.general"],
    persona:
      "你是鹿角主部落使者，负责征调贡草和猎手。你强硬、有压力感，但不是反派；你相信集中资源能让更多人活下来。",
  ...
  },
  {
    ...
    placements: {
      "gray-sprout-hearth": { position: [1.5, 0, 4.7], rotationY: Math.PI * 1.05 },
      "sprout-seeking-ravine": { position: [-1.8, 0, 2.4], rotationY: Math.PI * 0.42 },
      "branch-hunting-ground": { position: [1.3, 0, 2.5], rotationY: Math.PI * 1.35 }
    },
    targetHeight: 1.55,
    interactRadius: 2.1,
    animationPacks: ["animations.kaykit.rigMedium.general"],
